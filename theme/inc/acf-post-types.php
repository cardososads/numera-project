            ...
            array(
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'field_66df38a7e1347',
                        'label' => 'Nome completo',
                        'name' => '_assinaturas_nome_completo',
                        'aria-label' => '',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 1,
                    ...
                    array(
                        'key' => 'field_66df38e7e1348',
                        'label' => 'Data de nascimento',
                        'name' => '_assinaturas_data_nascimento',
                        'aria-label' => '',
                        'type' => 'date_picker',
                        'instructions' => '',
                        'required' => 0,
...
add_action( 'init', function() {
    register_post_type( 'assinatura', array(
        'labels' => array(
            'name' => 'Assinaturas',
            'singular_name' => 'Assinatura',
            'menu_name' => 'Análise de Assinatura',
            'all_items' => 'Todos os Análise de Assinatura',
            'edit_item' => 'Editar Assinatura',
            'view_item' => 'Ver Assinatura',
            'view_items' => 'Ver Análise de Assinatura',
            'add_new_item' => 'Adicionar novo Assinatura',
            'add_new' => 'Adicionar novo Assinatura',
            'new_item' => 'Novo Assinatura',
            'parent_item_colon' => 'Assinatura ascendente:',
            'search_items' => 'Pesquisar Análise de Assinatura',
            'not_found' => 'Não foi possível encontrar análise de assinatura',
            'not_found_in_trash' => 'Não foi possível encontrar análise de assinatura na lixeira',
            'archives' => 'Arquivos de Assinatura',
            'attributes' => 'Atributos de Assinatura',
            'insert_into_item' => 'Inserir no assinatura',
            'uploaded_to_this_item' => 'Enviado para este assinatura',
            'filter_items_list' => 'Filtrar lista de análise de assinatura',
            'filter_by_date' => 'Filtrar análise de assinatura por data',
            'items_list_navigation' => 'Navegação na lista de Análise de Assinatura',
            'items_list' => 'Lista de Análise de Assinatura',
            'item_published' => 'Assinatura publicado.',
            'item_published_privately' => 'Assinatura publicado de forma privada.',
            'item_reverted_to_draft' => 'Assinatura revertido para rascunho.',
            'item_scheduled' => 'Assinatura agendado.',
            'item_updated' => 'Assinatura atualizado.',
            'item_link' => 'Link de Assinatura',
            'item_link_description' => 'Um link para um assinatura.',
        ),
        'public' => true,
        'show_in_rest' => true,

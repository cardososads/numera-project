...
function download_endereco_docx()
{
    if (isset($_GET['download_endereco_docx'])) {
        ...
        send_php_word_docx($phpWord, 'analise_endereco');
    }
}

add_action('template_redirect', 'download_endereco_docx');
